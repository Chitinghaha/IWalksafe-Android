...
public final class FragmentNavigationBinding implements ViewBinding {
  ...
  private FragmentNavigationBinding(@NonNull FrameLayout rootView, @NonNull Button tohome,
      @NonNull Button tomap) {
  ...
  public static FragmentNavigationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tomap;
      Button tomap = ViewBindings.findChildViewById(rootView, id);
      if (tomap == null) {
        break missingId;
      }

      return new FragmentNavigationBinding((FrameLayout) rootView, tohome, tomap);
    }
