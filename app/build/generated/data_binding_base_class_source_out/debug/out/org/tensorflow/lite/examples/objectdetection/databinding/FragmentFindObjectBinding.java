...
public final class FragmentFindObjectBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentFindObjectBinding(@NonNull ConstraintLayout rootView, @NonNull Button cmDetect,
      @NonNull Button cmFind, @NonNull Button cmSetting, @NonNull OverlayView overlay,
  ...
  @NonNull
  public static FragmentFindObjectBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentFindObjectBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_find_object, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentFindObjectBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFindObjectBinding((ConstraintLayout) rootView, cmDetect, cmFind, cmSetting,
          overlay, viewFinder);
    }
