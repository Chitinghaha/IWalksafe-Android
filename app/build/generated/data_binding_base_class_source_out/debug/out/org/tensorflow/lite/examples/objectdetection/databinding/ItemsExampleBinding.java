...
public final class ItemsExampleBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ItemsExampleBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemsExampleBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.items_example, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemsExampleBinding bind(@NonNull View rootView) {
